 ...
 *
 * الرابط يُقترح من الاسم ويُعدَّل. وهو عنوان صفحته العامة التي يقرأ منها
 * جدوله — يمكن تعديله لاحقاً من تبويب المشايخ (`EditSheikhForm.tsx`)،
 * وعندها يُخيَّر المشرف صراحة بين تطبيقه على سلاسله ولقاءاته القائمة أو
 * الإبقاء عليها بالقديم.
 */
